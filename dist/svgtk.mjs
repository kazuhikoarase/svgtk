const h = function(e, ...n) {
  ...
  return {
    ...
    on: function(n, r) {
      e = e || (e = {}), (e[n] || (e[n] = [])).push(r);
    },
    off: function(n, r) {
      if (!e) return;
      const c = e[n];
      c && (e[n] = c.filter(function(t) {
        return t != r;
      }));
    }
  };
  ...
  return "svg g path rect circle text".split(/\s+/g).forEach(function(n) {
    ...
    return typeof n == "string" && (n = e[n] ? document.createElementNS("http://www.w3.org/2000/svg", n) : document.createElement(n)), {
      $el: n,
      on: function(r, c) {
        return this.$el.addEventListener(r, c), this;
      },
      off: function(r, c) {
        return this.$el.removeEventListener(r, c), this;
      },
      attrs: function(r) {
        for (let c in r)
          this.$el.setAttribute(c, "" + r[c]);
        return this;
      },
      props: function(r) {
        for (let c in r)
      ...
      append: function(r) {
        return this.$el.appendChild(r.$el), this;
      },
      remove: function(r) {
        return this.$el.removeChild(r.$el), this;
      }
    };
  };
  ...
  const n = [];
  (function() {
    for (let t = 0; t <= e.n; t += 1) {
      const o = (e.max - e.min) * t / e.n + e.min;
      n.push([e.fn(o), e.fn(o + e.dt)]);
    }
  })();
  const r = [];
  (function() {
    for (let t = 0; t < e.n; t += 1) {
      ...
      t == 0 && r.push([n[t][0][0], n[t][0][1]]), isNaN(o[0]) && (o = n[t][0]), r.push([o[0], o[1], n[t + 1][0][0], n[t + 1][0][1]]);
    }
  })();
  const c = r;
  return c.points = n, r;
  ...
  const e = {
    ...
    rotateX: function(t) {
      const o = Math.cos(t), i = Math.sin(t);
      return this.concat([
        1,
        0,
        0,
  ...
  return {
    ...
    quadTo: function(n, r, c, t) {
      return e += "Q" + n + " " + r + " " + c + " " + t, this;
    },
    cubicTo: function(n, r, c, t, o, i) {
      return e += "C" + n + " " + r + " " + c + " " + t + " " + o + " " + i, this;
    },
    close: function() {
      return e += "Z", this;
    },
  ...
  return {
    translate: function(n, r) {
      return e += "translate(" + n + " " + r + ")", this;
    },
    rotate: function(n) {
      return e += "rotate(" + l(n) + ")", this;
    },
    scale: function(n, r) {
      return e += "scale(" + n + " " + r + ")", this;
    },
    skewX: function(n) {
      return e += "skewX(" + l(n) + ")", this;
    },
    skewY: function(n) {
      return e += "skewY(" + l(n) + ")", this;
    },
    build: function() {
      return e;
    }
